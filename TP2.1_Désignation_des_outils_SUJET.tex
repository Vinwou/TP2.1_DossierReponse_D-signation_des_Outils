...
\marginnote{0,25 pt/réponse \\ = 1,75 pt}
...
\begin{minipage}{.55\linewidth}
\begin{itemize}
    \item Arête de coupe \begin{tikzpicture} \draw (0,0) circle (0.5) ; \draw (1,0) circle (0.5) ; \draw (2,0) circle (0.5) ; \end{tikzpicture};
    \item Face en dépouille \begin{tikzpicture} \draw (0,0) circle (0.5) ; \draw (1,0) circle (0.5) ;\end{tikzpicture};
    \item Goujure \begin{tikzpicture} \draw (0,0) circle (0.5) ; \end{tikzpicture};
    \item Face de coupe \begin{tikzpicture} \draw (0,0) circle (0.5) ; \draw (1,0) circle (0.5) ;\end{tikzpicture};
\end{itemize} 
\end{minipage}
\begin{minipage}{.44\linewidth}
\begin{itemize}
    \item \begin{tikzpicture} \draw (0,0) circle (0.5) ; \draw (1,0) circle (0.5) ; \draw (2,0) circle (0.5) ; \end{tikzpicture}Bec de l'outil (rayon de bec) ;
    \item Angle d'hélice\begin{tikzpicture} \draw (0,0) circle (0.5) ; \end{tikzpicture};
    \item Listel\begin{tikzpicture} \draw (0,0) circle (0.5) ; \end{tikzpicture};
    \item Brise copeaux\begin{tikzpicture} \draw (0,0) circle (0.5) ; \end{tikzpicture};
\end{itemize} 
\end{minipage}
...
\begin{center}
\includegraphics[width=0.5\linewidth]{PLA1.JPG}
\end{center}
\marginnote{0,25 pt \\ 0,25 pt}
\begin{tikzpicture}
\draw (0,0) -- (0,2) ;
\draw (0,2) -- (15,2) ;
\draw (15,2) -- (15,0) ;
\draw (15,0) -- (0,0) ;
\draw (7.5,0) -- (7.5,2) ;
\draw (0.2,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {P :};
\draw (7.7,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {N :};
\end{tikzpicture}
...
\draw (15,0) -- (0,0) ;
\draw (7.5,0) -- (7.5,2) ;
\draw (0.2,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {M :};
\draw (7.7,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {S :};
\end{tikzpicture}  
...
\draw (15,0) -- (0,0) ;
\draw (7.5,0) -- (7.5,2) ;
\draw (0.2,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {K :};
\draw (7.7,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {H :};
\end{tikzpicture}  
...
\begin{center}
\includegraphics[width=0.85\linewidth]{PLA25.JPG}
\end{center}
...
\marginnote{0,25 pt \\ 0,25 pt \\ 0,25 pt}
\begin{tikzpicture}
\draw (0,0) -- (0,2) ;
\draw (0,2) -- (15,2) ;
\draw (15,2) -- (15,0) ;
\draw (15,0) -- (0,0) ;
\draw (7.5,0) -- (7.5,2) ;
\draw (0.2,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {Case 5 :};
\draw (7.7,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {Case 6 :};
\end{tikzpicture}  
...
\draw (7.5,0) -- (0,0) ;
\draw (7.5,0) -- (7.5,2) ;
\draw (0.2,1.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {Case 7 :};
...
\draw (0.2,4.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {Sous-phase 210 : (porte-outil - outil - plaquette choisi)};
\end{tikzpicture}  
...
\draw (0.2,4.9) node [anchor=north west][inner sep=0.75pt]   [align=left] {Sous-phase 211 : (porte-outil - outil - plaquette choisi)};
\end{tikzpicture} 
